...
export default function App() {
  ...
  const t = {
    ...
    zh: {
      ...
      hero: {
        servicesButton: "三日搞掂個 website • 兩小時講清 AI 點用 • WhatsApp 隨時call我（連夜晚九點都覆）",
      ...
      <section id="faq" className="relative z-10 px-6 py-20">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center bg-gray-800/20 backdrop-blur-md border border-gray-600/30 rounded-3xl p-12">
            ...
            <Button
              onClick={() => window.open('https://wa.me/85255461658', '_blank')}
              className="bg-gray-800/40 backdrop-blur-md border border-gray-600/30 text-white hover:bg-gray-700/50 transition-all duration-300 rounded-full px-12 py-4 font-light text-lg"
            >
