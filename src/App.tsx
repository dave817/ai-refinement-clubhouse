        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              {/* Services button */}
              <Button className="bg-purple-500/20 backdrop-blur-md border border-purple-400/30 text-white hover:bg-purple-500/30 transition-all duration-300 rounded-full px-3 py-2 text-[10px] sm:text-sm md:text-base sm:px-6 whitespace-normal text-center leading-relaxed">
